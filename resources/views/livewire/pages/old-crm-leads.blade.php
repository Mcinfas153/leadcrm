<div class="container-fluid">
    <livewire:components.navigator title="old crm leads"/>
                    ...
                    <tbody>
                      ...
                      @endif    
                        ...
                        <tr>
                            ...
                            <td>{{ Auth::user()->user_type == config('custom.USER_ADMIN') ? $lead->created_at : $lead->assign_time }}</td>
...
{{-- agent change modal  --}}
    ...
    >
   <div class="modal-dialog modal-sm">
    <form action="{{ route('import.oldcrm.leads') }}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="modal-content">
         <div
            class="modal-header d-flex align-items-center modal-colored-header bg-success text-white"
